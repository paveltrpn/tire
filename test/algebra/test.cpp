...
BOOST_AUTO_TEST_CASE(case_vector2_construct_and_arithmetic, *utf::tolerance(0.00001)) {
    constexpr size_t __SZ = 2;
    tire::vector2<float> one{ 0.0f, 1.0f };
    tire::vector2<float> two{ 0.0f, 0.0f };
    tire::vector2<float> three{ 1.0f, 1.0f };
