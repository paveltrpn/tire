...
void CScreenText::drawString(std::string string) {
    ...
    float tc_gap_x
      = 1.0f / fontColumn;  // Размер ячейки с символом в долях текстурных координат по горизонтали
    float tc_gap_y
      = 1.0f / fontRow;  // Размер ячейки с символом в долях текстурных координат по вертикали
