...
void registerCollisionShapes() {
    {
        btCollisionShape* groundShape
          = new btBoxShape(btVector3(btScalar(10.0f), btScalar(0.5f), btScalar(10.0f)));
    ...
    {
        btCollisionShape* wallLeft
          = new btBoxShape(btVector3(btScalar(0.5f), btScalar(5.0f), btScalar(10.0f)));
        ...
        btDefaultMotionState* myMotionState = new btDefaultMotionState(groundTransform);
        btRigidBody::btRigidBodyConstructionInfo rbInfo(
          mass, myMotionState, wallLeft, localInertia);
        btRigidBody* body = new btRigidBody(rbInfo);
    ...
    {
        btCollisionShape* wallBack
          = new btBoxShape(btVector3(btScalar(10.0f), btScalar(5.0f), btScalar(0.5f)));
        ...
        btDefaultMotionState* myMotionState = new btDefaultMotionState(groundTransform);
        btRigidBody::btRigidBodyConstructionInfo rbInfo(
          mass, myMotionState, wallBack, localInertia);
        btRigidBody* body = new btRigidBody(rbInfo);
...

    {
        ...
        btCollisionShape* colShape
          = new btBoxShape(btVector3(btScalar(2.0f), btScalar(2.0f), btScalar(2.0f)));
...
void appSetup() {
    ...
    std::vector<glm::vec4> diffuse
      = { glm::vec4(1.5f, 1.5f, 1.5f, 1.0f), glm::vec4(0.7f, 0.7f, 0.7f, 1.0f) };
    std::vector<glm::vec4> lightPosition
      = { glm::vec4(15.0f, 10.0f, 15.0f, 1.0f), glm::vec4(-35.0f, -5.0f, -20.0f, 1.0f) };
