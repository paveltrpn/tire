...
export module pipeline : pipelinetestbox;
...
export struct PiplineTestBox final : Pipeline {
    PiplineTestBox() = default;
    ...
    auto buildPipeline( const Program& program ) -> void override {
        ...
        vkCreatePipelineCache( Context::instance().device(), &pipelineCacheInfo, nullptr, &_pipelineCache );
