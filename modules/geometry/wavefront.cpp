...
export module geometry : wavefront;
import : node;
...
export {
    ...
    public:
        ...
        [[nodiscard]] std::shared_ptr<tire::Node> getAsNode( std::string_view path ) { return {}; }
...
faces: {}
            ...
            rhs.objectName_, rhs.matlibFileName_, rhs.verteciesCount_, rhs.normalsCount_, rhs.texCoordsCount_,
            rhs.facesCount_ );
        return os;
    }
}
