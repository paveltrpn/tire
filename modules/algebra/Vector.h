...
concept ConceptVector
  = std::is_same_v<T, Vector4ll> || std::is_same_v<T, Vector3f> || std::is_same_v<T, Vector4d>
    || std::is_same_v<T, Vector4i> || std::is_same_v<T, Vector4ui> || std::is_same_v<T, Vector3ll>
    || std::is_same_v<T, Vector3f> || std::is_same_v<T, Vector3d> || std::is_same_v<T, Vector3i>
    || std::is_same_v<T, Vector3ui> || std::is_same_v<T, Vector2ll> || std::is_same_v<T, Vector2f>
