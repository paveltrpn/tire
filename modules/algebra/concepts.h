...
template <typename T>
concept Algebraic = std::is_same_v<T, float> || std::is_same_v<T, double> ||
                    std::is_same_v<T, int> || std::is_same_v<T, unsigned int> ||
                    std::is_same_v<T, long> || std::is_same_v<T, long long>;

template <typename T>
requires Algebraic<T> struct matrix2;
...
template <typename T>
requires Algebraic<T> struct vector3;

template <typename T>
requires Algebraic<T> struct vector4;

template <typename T>
concept MatrixFloat =
    std::is_same_v<T, matrix2<float>> || std::is_same_v<T, matrix3<float>> ||
    std::is_same_v<T, matrix4<float>>;

template <typename T>
concept MatrixDouble =
    std::is_same_v<T, matrix2<double>> || std::is_same_v<T, matrix3<double>> ||
...
concept VectorDouble =
    std::is_same_v<T, vector2<double>> || std::is_same_v<T, vector3<double>> ||
